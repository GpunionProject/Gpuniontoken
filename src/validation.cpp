...
#if defined(NDEBUG)
# error "Gpunion cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Gpunion Signed Message:\n";
...
CAmount GetBlockSubsidy(int nHeight, const Consensus::Params& consensusParams)
{
    ...
    // Subsidy is cut in half every 100,000 blocks which will occur approximately every 2 years.
    nSubsidy >>= halvings;
    return nSubsidy;
}
