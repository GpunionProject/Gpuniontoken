...
std::map<CTxDestination, std::vector<COutput>> CWallet::ListCoins() const
{
    ...
    // https://github.com/GpunionProject/Gpuniontoken/pull/10340, but that change has been
    // postponed until after https://github.com/GpunionProject/Gpuniontoken/pull/10244 to
                                ...
                                int& nChangePosInOut, std::string& strFailReason, const CCoinControl& coin_control, bool sign)
{
    ...
    unsigned int nBytes;
    {
        ...
        LOCK2(cs_main, cs_wallet);
        {
            ...
            // change transaction isn't always pay-to-gpunion-address
 ...
 * https://gpuniontalk.org/?topic=54527, or
 * https://github.com/GpunionProject/Gpuniontoken/pull/1393.
 */
