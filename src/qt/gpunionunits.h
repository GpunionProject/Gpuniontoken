...
#ifndef GPUNION_QT_GPUNIONUNITS_H
#define GPUNION_QT_GPUNIONUNITS_H
...
/** Gpunion unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class GpunionUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit GpunionUnits(QObject *parent);

    /** Gpunion units.
      @note Source: https://en.gpunion.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        GUT,
...
typedef GpunionUnits::Unit GpunionUnit;

#endif // GPUNION_QT_GPUNIONUNITS_H
