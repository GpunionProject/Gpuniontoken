...
#include "qt/gpunionamountfield.h"
...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<GpunionAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_gpunion-qt -platform xcb      # Linux
//     src/qt/test/test_gpunion-qt -platform windows  # Windows
//     src/qt/test/test_gpunion-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = GpunionUnits::formatWithUnit(unit, balance, false, GpunionUnits::separatorAlways);
    ...
    // Amount input
    GpunionAmountField* amountInput = receiveCoinsDialog.findChild<GpunionAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: gpunion:")) != -1);
