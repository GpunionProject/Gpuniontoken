...
{
    BOOST_CHECK(TestSplitHost("www.gpunion.io", "www.gpunion.io", -1));
    BOOST_CHECK(TestSplitHost("[www.gpunion.io]", "www.gpunion.io", -1));
    BOOST_CHECK(TestSplitHost("www.gpunion.io:80", "www.gpunion.io", 80));
    BOOST_CHECK(TestSplitHost("[www.gpunion.io]:80", "www.gpunion.io", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:8423", "127.0.0.1", 8423));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:8423", "127.0.0.1", 8423));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:8423", "::ffff:127.0.0.1", 8423));
    BOOST_CHECK(TestSplitHost("[::]:8423", "::", 8423));
    BOOST_CHECK(TestSplitHost("::8423", "::8423", -1));
    BOOST_CHECK(TestSplitHost(":8423", "", 8423));
    BOOST_CHECK(TestSplitHost("[]:8423", "", 8423));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:8423", "127.0.0.1:8423"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:8423", "[::]:8423"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
