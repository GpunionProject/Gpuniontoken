...
#ifndef GPUNION_TEST_SCRIPTNUM10_H
#define GPUNION_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Gpunion Core 0.10.0, for cross-comparison.
 */
public:
