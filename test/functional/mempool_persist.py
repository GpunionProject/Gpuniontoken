...
By default, gpuniond will dump mempool on shutdown and
...
class MempoolPersistTest(GpunionTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give gpuniond a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent gpuniond from writing mempool.dat to disk. Verify that `savemempool` fails")
