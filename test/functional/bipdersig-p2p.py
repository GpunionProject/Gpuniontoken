...
class BIP66Test(GpunionTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # gpuniond is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and gpuniond produces more specific reject
            # reasons.
