...
class TxnMallTest(GpunionTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 GUT:
        ...
        # First: use raw transaction API to send 1240 GUT to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 GUT coin each
        ...
        # Node0's balance should be starting balance, plus 50GUT for another
        ...
        # Node0's total balance should be starting balance, plus 100GUT for 
