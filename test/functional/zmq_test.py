...
from test_framework.test_framework import GpunionTestFramework, SkipTest
...
class ZMQTest (GpunionTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that gpunion has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("gpuniond has not been built with zmq enabled.")
