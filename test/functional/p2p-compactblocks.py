...
# TestNode: A peer we use to send messages to gpuniond, and store responses.
...
class CompactBlocksTest(GpunionTestFramework):
    ...
    # This test actually causes gpuniond to (reasonably!) disconnect us, so do this last.
    ...
    # Test that gpuniond requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for gpuniond to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # gpuniond will not send blocktxn responses for blocks whose height is
