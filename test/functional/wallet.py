...
class WalletTest(GpunionTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 GUT from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 GUT with subtract fee from amount
        ...
        # Sendmany 10 GUT with subtract fee from amount
